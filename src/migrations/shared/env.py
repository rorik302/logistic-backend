...
from src.models import shared_models  # noqa
...
def do_run_migrations(connection: Connection) -> None:
    connection.execute(text(f"SET search_path TO {settings.database.SHARED_SCHEMA_NAME}"))
    connection.commit()
    connection.dialect.default_schema_name = settings.database.SHARED_SCHEMA_NAME
